                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
									...
									<tr>
										<td class="price"><?= $product['IDEvent']; ?></td>
										<td><?= $product['idClient']; ?></td>
										<td><?= $product['titre']; ?></td>
										<td><?= $product['dateEvent']; ?></td>
                                        <td><?= $product['lieu']; ?></td>
										...
										<td align="center">
											<form method="POST" action="updateevent.php">
												...
												<input type="hidden" value=<?PHP echo $product['IDEvent']; ?> name="IDEvent">
											</form>
										</td>
										<td>
											<a href="deleteevent.php?IDEvent=<?php echo $product['IDEvent']; ?>" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip">
												<i class="ti-trash"></i>
											</a>
										</td>
									</tr>
