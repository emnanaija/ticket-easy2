        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="  <ul class="metismenu" id="menu">
        ...
        <div class="content-body">
            <form action="" method="POST" onsubmit="return validateForm()">
                <table border="1" align="center">
                    ...
                    <tr>
                        <td>
                            <label for="number  Client">number:
                            </label>
                        </td>
                        <td>
                            <input type="number" name="numberClient" id="numberClient">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr align="center">
                        <td>
                            <input type="submit" value="Save" class="btn btn-primary light ">
                        </td>
                        <td>
                            <input type="reset" value="Reset" class="btn btn-primary light ">
                        </td>
                    </tr>
                    <center>
