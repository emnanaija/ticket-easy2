...
if (
    ...
    if ($error == "")
        ...
        if (
            ...
            $product = new moviecategory(
                null,
                $_POST['categoryName']
                
            );
            $productC->updatemoviecategory($product, $_POST["idcategory"]);
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <?php if (isset($_POST['idcategory'])) {
                                        $product = $productC->showmoviecategory($_POST['idcategory']);
                                    ?>
                                        <form action="" method="POST" id="OrderForm" id="OrderForm" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" id="idcategory" name="idcategory" readonly value="<?php echo $product['idcategory']; ?>">
                                                </div>


                                                <div class="form-group col-md-6">
                                                    <label for="productName">Add the name of the  category</label>
                                                    <input type="text" class="form-control" placeholder="Movie Category " name="categoryName" id="categoryName" value="<?php echo $product['categoryName']; ?>">
    ...
    ***********************************-->
    ...
    <script>
      ...
      form.addEventListener('submit', (event) => {
        ...
        if (categoryName.value === '' || !/^[a-zA-Z]+$/.test(categoryName.value)) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid categoryName (only letters)',
          });
          isValid = false;
        }
