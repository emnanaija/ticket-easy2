...
if (
	...
	if ($error == "")
		...
		if (
			!empty($_POST['categoriesnack'])

		) {
			$product = new categoriesnack(
				null,
				$_POST['categoriesnack']
			);
			$productC->updatecategoriesnack($product, $_POST["idcategoriesnack"]);
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="basic-form">
									...
									<?php if (isset($_POST['idcategoriesnack'])) {
										$product = $productC->showcategoriesnack($_POST['idcategoriesnack']);
									?>
										<form action="" method="POST" id="OrderForm" id="OrderForm" enctype="multipart/form-data">
											...
											<div class="form-row">
												...
												<div class="form-group col-md-6">
													<label>ID Categories Snack</label>
													<input type="number" class="form-control" readonly id="idcategoriesnack" name="idcategoriesnack" min=0 value="<?php echo $product['idcategoriesnack']; ?>">
												</div>


												<div class="form-group col-md-6">
													<label for="productName">Add the name of the category Snack</label>
													<input type="text" class="form-control" placeholder="Category Name" name="categoriesnack" id="categoriesnack" value="<?php echo $product['categoriesnack']; ?>">
												</div>
    ...
    ***********************************-->
    ...
    <script>
      ...
      form.addEventListener('submit', (event) => {
        ...
        const categoriesnack = document.querySelector('#categoriesnack');

        let isValid = true;

        if (categoriesnack.value === '' || !/^[a-zA-Z]+$/.test(categoriesnack.value)) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid categorie snack (only letters)',
          });
          isValid = false;
        }
