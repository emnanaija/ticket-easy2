...
if (
    ...
    if (
        ...
        $orderC->updatePayment($order, $_POST["idPay"]);
    ...
    <div id="main-wrapper">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <div class="header-info">
                                        <span>Hello, <strong>rihem</strong></span>
                                    </div>
                                    <img src="./images/rihem.png" width="20" alt="" />
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
        ...
        ***********************************-->
        <div class="content-body">
            <!-- row -->
            <a href="afficherevent.php">Go To Events </a>
            <hr>
            ...
            <div class="container-fluid">
                <div class="form-head d-flex mb-3 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-0">Update Your Event</h2>
                        <ol class="breadcrumb">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    $order = $orderC->showPayment($_POST['idPay']);
                                    ...
                                    <form action="" id="OrderForm" method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" class="form-control" readonly value="<?php echo $order['idPay']; ?>" id="idPay" name="idPay">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Total Price</label>
                                                <input type="number" class="form-control" readonly value="<?php echo $order['Total']; ?>" id="Total" name="Total">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Card Type</label>
                                                <input type="text" class="form-control" value="<?php echo $order['card_type']; ?>" id="card_type" name="card_type">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Card Number</label>
                                                <input type="number" class="form-control" value="<?php echo $order['cardNumber']; ?>" id="cardNumber" name="cardNumber">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>CVC</label>
                                                <input type="number" class="form-control"  value="<?php echo $order['CVC']; ?>" id="CVC" name="CVC">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Order ID</label>
                                                <input type="number" class="form-control" readonly value="<?php echo $order['idOrder']; ?>" id="idOrder" name="idOrder">
                                            </div>
    ...
    <script>
       const form = document.querySelector('#OrderForm');
        ...
        form.addEventListener('submit', (event) => {
            ...
            if (card_type.value === '' || !/^[a-zA-Z -]+$/.test(card_type.value)) {
                Swal.fire({
                    icon: 'error',
                    title: 'Oops...',
                    text: 'Please enter a valid card_type (only letters)',
                });
                isValid = false;
            }
            if (cardNumber.value === '' || isNaN(cardNumber.value) || cardNumber.value <= 0) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid card Number (numeric value greater than 0)',
          });
          isValid = false;
        }
        if (CVC.value === '' || isNaN(CVC.value) || CVC.value <= 0) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid CVC (numeric value greater than 0)',
          });
          isValid = false;
        }
