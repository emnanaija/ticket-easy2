...
if (
    ...
    )
    {
        ...
        $reclamationC->updateReclamation($client, $_POST["idRec"]);
...
-->
        ...
        ***********************************-->
        <div class="content-body">
            <!-- row -->
            <center>
        <h1>Update Recalamtion</h1>
        <h2>
            <a href="listReclamation.php" class="btn btn-primary light ">Back to List Recalamtion</a>
        </h2>
            </center>
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						<h2 class="text-black font-w600 mb-0">Reclamations</h2>
						<p class="mb-0">Here is your Reclamations list data</p>
					</div>
    ...
    if (isset($_POST['idRec'])) {
        $client = $reclamationC->showReclamation($_POST['idRec']);
    }
    ?>
        ...
        <form action="" method="POST" name="contact-form" id="contact-form" >
           ...
           <div class="form-row 1">
              ...
              <input required type="text" class="form-control input" name="idRec" id="idRec" maxlength="20" placeholder=" " value="<?php echo $client['idRec']; ?>" >
              <label for="idRec" class="">Id</label>
              <div class="underline">
              </div>
            </div>
            <br>
            ...
            <div class="form-group col-md-6 column">
              <input required type="text" class="form-control input" name="firstName" id="firstName" maxlength="20" placeholder=" " value="<?php echo $client['firstName']; ?>" >
            ...
            <div class="form-group col-md-6 column">
              <input required type="text" class="form-control input" name="lastName" id="lastName" value="<?php echo $client['lastName']; ?>" maxlength="20" placeholder=" " >
          ...
          <div class="form-row one1">
            <div class="form-group col-lg-6 column">
              <input required type="email" value="<?php echo $client['address']; ?>" class="form-control input" name="address" id="address" placeholder=" " >
         ...
         <br>
          ...
          <div class="form-row size">
            <div class="form-group col-md-6 column">
            <input   required type="date" value="<?php echo $client['dor']; ?>" class="form-control input" name="dor" id="dor" placeholder=" " max="<?php echo date("Y-m-d"); ?>" min="2023-01-01" >
          ...
          <div class="form-row size">
            <div class="form-group col-md-6 column">
              <textarea required type="text" value="<?php echo $client['texte']; ?>" class="form-control input" name="texte" id="texte" rows="5"  placeholder=" " min="15"></textarea>
          ...
          <div class="btn-sm">
            <input type="submit" value="Update" class="btn btn-primary light " id="submit-btn"> 
            <input  align="right" type="reset" value="Reset" class="btn btn-primary light ">
          </div>
        </form>
						</div>
                    </div>
