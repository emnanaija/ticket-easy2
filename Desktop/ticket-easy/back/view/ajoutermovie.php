...
$query = "SELECT * FROM moviecategory ORDER BY categoryName DESC";
					...
					<div class="collapse navbar-collapse justify-content-between">
						...
						<ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown header-profile">
								...
								<div class="dropdown-menu dropdown-menu-right">
									<a href="../../../../xhtml/admin.php" class="dropdown-item ai-icon">
...
<div class="form-group col-md-6">
	...
	<input type="text" class="form-control" placeholder="Movie name" name="movieName" id="movieName">
</div>
<div class="form-group col-md-6">
	<label for="description">Add the Description</label>
	<input type="text" class="form-control" placeholder="description Movie" name="descriptionMovie" id="descriptionMovie" >
</div>
<div class="form-group col-md-6">
	<label for="trailer">Add the trailer</label>
	<input type="text" class="form-control" placeholder="trailer" name="trailer" id="trailer">
</div>
<div class="form-group col-md-6">
...
<div class="form-group col-md-6">
	...
	<input type="text" class="form-control" placeholder="dateRelease" name="dateR" id="dateR">
</div>
<div class="form-group col-md-6">
	<label for="rate">Add the rate</label>
	<input type="float" class="form-control" placeholder="rate" name="rate" id="rate">
</div>


<div class="form-group col-md-6">
	<label for="priceProd">Add the price of the Ticket</label>
	<input type="number" class="form-control" placeholder="price" name="priceTicket" id="priceTicket">
</div>

<div class="form-group col-md-6">
	<label for="quantityProd">Add the quantity of the Tickets</label>
	<input type="number" class="form-control" placeholder="quantityTickets" name="quantityTickets" id="quantityTickets">
</div>

<div class="form-group col-md-6">
	<label for="providerName">Add the date of the Movie</label>
	<input type="date" class="form-control" placeholder="date Movie" name="dateMovie" id="dateMovie" >
</div>
<div class="form-group col-md-6">
	<label for="providerName">Add the ID of the Room</label>
	<input type="number" class="form-control" placeholder="IDRoom" name="idroom" id="idroom" >
</div>

<div class="form-group col-md-6">
	<label for="imageProd">Add the Poster of the Movie</label>
	<input type="file" class="form-control" placeholder="image" name="moviePoster" id="moviePoster" >
</div>
...
<script>
											...
											<div class="widget widget-list-product" style="position: relative; display: inline-block; padding-top: 20px; padding-left: 130px;">
												<label for="categorySelect">Categories</label>
												<div id="categorySelect">
													<?php foreach ($result as $row) { ?>
														<div class="form-check">
															<input class="form-check-input categorySelect" type="radio" name="idcategory" id="idcategory" value="<?php echo $row['idcategory']; ?>">
															<label class="form-check-label" for="<?php echo $row['categoryName']; ?>">
											...
											<script>
												...
												for (let i = 0; i < categorySelect.length; i++) {
													categorySelect[i].addEventListener('change', function() {
														// Make sure only one category is selected
														if (this.checked) {
															for (let j = 0; j < categorySelect.length; j++) {
																if (j !== i) {
																	categorySelect[j].checked = false;
																}
															}
														}
													});
    ...
    ***********************************-->
	...
	<script>
      ...
      form.addEventListener('submit', (event) => {
		...
		const idcategory = document.querySelectorAll('.categorySelect:checked');
        let isValid = true;
		...
		if (dateR.value === '' || !/^[0-9 a-zA-Z]+$/.test(dateR.value)) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid dateR',
          });
          isValid = false;
        }
