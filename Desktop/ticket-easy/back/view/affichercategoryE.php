...
$productC = new EventCategoryc();

$list = $productC->listEvent();

$product1C = new EventCategoryc();
$list1 = $product1C->listEvent();
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div id="main-wrapper">
													...
													<li>
														<div class="timeline-panel">
															...
															<div class="media-body">
																...
																<small class="d-block">Please contact you provider : <?php echo $product['category']; ?> </small>
															</div>
														</div>
        ...
        ***********************************-->
		<div class="content-body">
            ...
            <h2>
				<a href="ajoutercategory.php" class="btn btn-primary light ">Ajouter Categorie</a>
			</h2>
                            ...
                            <div class="card-body">
                                <div class="new-arrival-product">
									...
									<tr>
										...
										<td><?= $product['idCategorieE']; ?></td>
										<td><?= $product['EventCategoryE']; ?></td>


										<td align="center">
											<form method="POST" action="updatecategoryE.php">
												<input type="submit" name="update" value="Update">
												<input type="hidden" value=<?PHP echo $product['idCategorieE']; ?> name="idCategorieE">
											</form>
										</td>
										<td>
											<a href="deletecategoryE.php?idCategorieE=<?php echo $product['idCategorieE']; ?>" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip">
												<i class="ti-trash"></i>
											</a>
										</td>
									</tr>
