...
if (
	...
	if ($error == "")
		...
		if (
			...
			$product = new Eventcategory(
                null,
                $_POST['EventCategoryE']
			);
			$productC->ajoutereventcategories($product);
...
<div class="form-group col-md-6">
	...
	<input type="text" class="form-control" placeholder="Event Category" name="EventCategoryE" id="EventCategoryE">
</div>
