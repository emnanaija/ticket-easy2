...
if (
    ...
    isset($_POST["priceTicket"]) &&
    isset($_POST["quantityTickets"]) &&
    isset($_POST["dateMovie"]) &&
    isset($_POST["idroom"]) &&
    isset($_POST["descriptionMovie"]) &&
    isset($_POST["trailer"]) &&
    isset($_POST["duration"]) &&
    isset($_POST["dateR"]) &&
    isset($_POST["rate"]) &&
    isset($_FILES["moviePoster"])&&
    ...
    if ($error == "")
        ...
        if (
            !empty($_POST['movieName']) &&
            !empty($_POST['priceTicket']) &&
            !empty($_POST['quantityTickets']) &&
            !empty($_POST['dateMovie']) &&
            !empty($_POST['idroom']) &&
            !empty($_POST['descriptionMovie']) &&
            !empty($_POST['trailer']) &&
            !empty($_POST['duration']) &&
            !empty($_POST['dateR']) &&
            !empty($_POST['rate']) &&
            !empty($_FILES['moviePoster'])&&
            ...
            $product = new Menu(
                ...
                $_POST['movieName'],
                $_POST['priceTicket'],
                $_FILES['moviePoster']['name'],
                $_POST['dateMovie'],
                $_POST['idroom'],
                $_POST['quantityTickets'],
                $_POST['descriptionMovie'],
                $_POST['trailer'],
                $_POST['duration'],
                $_POST['dateR'],
                $_POST['rate'],
            ...
            $productC->updateMovie($product, $_POST["idMovie"]);
...
<head>
    ...
    <title>Ticketeasy - Movie tickets Order Bootstrap Admin Dashboard</title>
    <!-- Favicon icon -->
                            ...
                            <div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body2">
                                <ul class="contacts">
                                    ...
                                    <li>
                                        <div class="d-flex bd-highlight">
                                            <div class="user_info">
                                                <span>john just buy your snack..</span>
                                                <p>10 Aug 2020</p>
                                            </div>
                                            <div class="ml-auto">
                                                <a href="#" class="btn btn-primary btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <div class="header-info">
                                        <span>Hello, <strong>erij</strong></span>
                                    </div>
                                    <img src="./images/erij.jpg" width="20" alt="" />
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <?php if (isset($_POST['idMovie'])) {
                                        $product = $productC->showMovie($_POST['idMovie']);
                                    ?>
                                        <form action="" method="POST" id="OrderForm" id="OrderForm" enctype="multipart/form-data">

                                            <div class="form-row">

                                                <div class="form-group col-md-6">
                                                    <label>ID Movie</label>
                                                    <input type="number" class="form-control" id="idMovie" name="idMovie" value="<?php echo $product['idMovie']; ?>">
                                                </div>


                                                <div class="form-group col-md-6">
                                                    <label for="productName">Add the name of the Movie</label>
                                                    <input type="text" class="form-control" placeholder="Movie name" name="movieName" id="movieName" value="<?php echo $product['movieName']; ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="description">Add the Description</label>
                                                    <input type="text" class="form-control" placeholder="description Movie" name="descriptionMovie" id="descriptionMovie" value="<?php echo $product['descriptionMovie']; ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="trailer">Add the trailer</label>
                                                    <input type="text" class="form-control" placeholder="trailer" name="trailer" id="trailer" value="<?php echo $product['trailer']; ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="duration">Add the duration</label>
                                                    <input type="text" class="form-control" placeholder="duration" name="duration" id="duration" value="<?php echo $product['duration']; ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="duration">Add the date Release</label>
                                                    <input type="text" class="form-control" placeholder="dateRelease" name="dateR" id="dateR" value="<?php echo $product['dateR']; ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="rate">Add the rate</label>
                                                    <input type="float" class="form-control" placeholder="rate" name="rate" id="rate" value="<?php echo $product['rate']; ?>">
                                                </div>


                                                <div class="form-group col-md-6">
                                                    <label for="priceProd">Add the price of the Ticket</label>
                                                    <input type="number" class="form-control" placeholder="price" name="priceTicket" id="priceTicket" value="<?php echo $product['priceTicket']; ?>">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="quantityProd">Add the quantity of the Tickets</label>
                                                    <input type="number" class="form-control" placeholder="quantityTickets" name="quantityTickets" id="quantityTickets" value="<?php echo $product['quantityTickets']; ?>">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="providerName">Add the date of the Movie</label>
                                                    <input type="date" class="form-control" placeholder="date Movie" name="dateMovie" id="dateMovie" value="<?php echo $product['dateMovie']; ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="providerName">Add the ID of the Room</label>
                                                    <input type="number" class="form-control" placeholder="IDRoom" name="idroom" id="idroom" value="<?php echo $product['idroom']; ?>">
                                                </div>

                                                <div class="form-group col-md-6">
                                                    <label for="imageProd">Add the Poster of the Movie</label>
                                                    <input type="file" class="form-control" placeholder="image" name="moviePoster" id="moviePoster" value="./images/<?php echo $product['moviePoster']; ?> ">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>ID Category</label>
                                                    <input type="number" class="form-control" id="idcategory" name="idcategory" value="<?php echo $product['idcategory']; ?>">
                                                </div>
    ...
    ***********************************-->
	...
	<script>
      ...
      form.addEventListener('submit', (event) => {
		...
		const priceTicket = document.querySelector('#priceTicket');
		const quantityTickets = document.querySelector('#quantityTickets');
        ...
        if (movieName.value === '' || !/^[a-zA-Z]+$/.test(movieName.value)) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid movie Name (only letters)',
          });
          isValid = false;
        }
		if (descriptionMovie.value === '' || !/^[ a-zA-Z]+$/.test(descriptionMovie.value)) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid descriptionMovie (only letters)',
          });
          isValid = false;
        }
		if (trailer.value === '') {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid trailer',
          });
          isValid = false;
        }
		if (duration.value === '' || !/^[0-9 a-zA-Z]+$/.test(duration.value)) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid duration (only letters)',
          });
          isValid = false;
        }
		if (dateR.value === '' || !/^[0-9a-zA-Z]+$/.test(dateR.value)) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid dateR (only letters)',
          });
          isValid = false;
        }
        if (rate.value === '' || isNaN(rate.value) || rate.value < 0) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid rate (only Numbers)',
          });
          isValid = false;
        }

        if (priceTicket.value === '' || isNaN(priceTicket.value) || priceTicket.value < 0) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid priceTicket (numeric value greater than or equal to 0)',
          });
          isValid = false;
        }
		if (quantityTickets.value === '' || isNaN(quantityTickets.value) || quantityTickets.value < 0) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid quantityTickets (numeric value greater than or equal to 0)',
          });
          isValid = false;
        }
		if (dateMovie.value === '') {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid dateMovie ',
          });
          isValid = false;
        }
		if (idroom.value === '' || isNaN(idroom.value) || idroom.value < 0) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid idroom (numeric value greater than or equal to 0)',
          });
          isValid = false;
        }
		if (idcategory.value === '' || isNaN(idcategory.value) ) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid idcategory  (numeric value greater than or equal to 0)',
          });
          isValid = false;
        }
