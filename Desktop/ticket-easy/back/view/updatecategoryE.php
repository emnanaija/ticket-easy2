...
if (
	isset($_POST["idCategorieE"]) &&
	isset($_POST["EventCategoryE"]) 
) {
	if (
		!empty($_POST["idCategorieE"]) &&
		!empty($_POST["EventCategoryE"]) 
	) {
		$order = new Eventcategory(
			$_POST['idCategorieE'],
			$_POST['EventCategoryE']
		);
		$orderC->updateeventcategories($order, $_POST["idCategorieE"]);
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="basic-form">
									...
									$order = $orderC->showeventcategories($_POST['idCategorieE']);
									...
									<form action="" id="OrderForm" method="POST">
                                        ...
                                        <div class="form-group col-md-6">
												...
												<input type="number" class="form-control" readonly value="<?php echo $order['idCategorieE']; ?>" id="idOrder" name="idCategorieE">
											</div>
											<div class="form-group col-md-6">
												<label>Category Name</label>
												<input type="text" class="form-control"  value="<?php echo $order['EventCategoryE']; ?>" id="EventCategoryE" name="EventCategoryE">
											</div>
    ...
    ***********************************-->
	...
	<script>
      ...
      form.addEventListener('submit', (event) => {
        ...
        const EventCategoryE = document.querySelector('#EventCategoryE');

        let isValid = true;

        if (EventCategoryE.value === '' || !/^[a-zA-Z]+$/.test(EventCategoryE.value)) {
          Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Please enter a valid EventCategoryE (only letters)',
          });
          isValid = false;
        }
