...
<body>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    ...
                                    <img src="images/emna.jpg" width="20" alt="" />
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
    ...
    <center>
        <form method="POST" action="banClients.php">
            <table border="1" align="center" width="70%">
                ...
                <tr>
                    <td><input type="checkbox" name="selectedClients[]" value="<?php echo $client['idClient']; ?>"></td>
                    ...
                    <td><a href="updateClient.php?idClient=<?php echo $client['idClient']; ?>"><?php echo $client['idClient']; ?></a></td>
                    <td>
            ...
            <br>
            <input class="btn btn-primary light " type="submit" name="banSelectedClients" value="Ban Selected Clients">
        </form>
        <br>
