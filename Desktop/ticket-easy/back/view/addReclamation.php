            ...
            <div class="container-fluid">
                <div class="form-head d-flex mb-3 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        ...
                        <p class="mb-0"> Reclamations data</p>
                    </div>
                ...
                <form action="" method="POST" name="contact-form" id="contact-form">
                    ...
                    <div class="form-row two2">
                        <div class="form-group col-md-6 column">
                            <input type="text" class="form-control input" name="firstName" id="firstName" maxlength="20" placeholder=" ">
                        ...
                        <div class="form-group col-md-6 column">
                            <input type="text" class="form-control input" name="lastName" id="lastName" maxlength="20" placeholder=" ">
                    ...
                    <div class="form-row size">
                        <div class="form-group column">
                            <input type="date" class="form-control input" name="dor" id="dor" placeholder=" " max="<?php echo date("Y-m-d"); ?>" min="2023-01-01">
                    ...
                    <div *class="form-group col-md-6 column">
                        <div class="form-group column">
                            <textarea type="text" class="form-control input" name="texte" id="texte" rows="5" minlength="10" placeholder=" "></textarea>
                    ...
                    <div class="btn-sm">
                        <input type="submit" value="send" class="btn btn-primary light " id="submit-btn">
