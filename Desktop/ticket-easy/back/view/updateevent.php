...
if (
	...
	if (
		...
		$order = new Event(
			...
			$_POST['titre'],
			$_POST['idClient'],
            new DateTime($_POST['dateEvent']),
			$_POST['lieu'],
            $_POST['budget'],
			$_POST['categorie']
		);
		$orderC->updateevents($order, $_POST["IDEvent"]);
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="basic-form">
									...
									$order = $orderC->showevents($_POST['IDEvent']);
									...
									<form action="" method="POST">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<input type="number" class="form-control" readonly value="<?php echo $order['IDEvent']; ?>" id="idOrder" name="IDEvent">
											</div>
											<div class="form-group col-md-6">
												<label>User ID</label>
												<input type="number" class="form-control" readonly value="<?php echo $order['idClient']; ?>" id="idClient" name="idClient">
											</div>
                                            <div class="form-group col-md-6">
												<label>lieu</label>
												<input type="text" class="form-control"  value="<?php echo $order['lieu']; ?>" id="idClient" name="lieu">
											</div>
										...
										<div class="form-group col-md-6">
											...
											<input type="date" class="form-control" value="<?php echo $order['dateEvent']; ?>" min="<?php echo date('Y-m-d'); ?>" id="orderDate" name="dateEvent">
										</div>
										<div class="form-group col-md-6">
											<label>budget</label>
											<input type="number" class="form-control" value="<?php echo $order['budget']; ?>" id="priceTotal" name="budget">
										</div>
                                        <div class="form-group col-md-6">
												<label>titre</label>
												<input type="text" class="form-control" readonly value="<?php echo $order['titre']; ?>" id="idClient" name="titre">
											</div>
                                            <div class="form-group col-md-6">
												<label>categorie</label>
												<input type="int" class="form-control"  value="<?php echo $order['categorie']; ?>" id="idClient" name="categorie">
											</div>
								</div>
