...
$productC = new snackC();
$list = $productC->listSnack();

$product1C = new snackC();
$list1 = $product1C->listSnack();
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div id="main-wrapper">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<div id="DZ_W_Notification1" class="widget-media dz-scroll p-3" style="height:380px;">
										...
										foreach ($list1 as $product) {
											if ($product['quantitySnack'] == 0) {
												// Fetch the category name based on the idcategoriesnack
												$idcategoriesnack = $product['idcategoriesnack'];
												$pdo = config::getConnexion();
												$sql = "SELECT categoriesnack FROM categoriesnack WHERE idcategoriesnack = :idcategoriesnack";
												$stmt = $pdo->prepare($sql);
												$stmt->execute(['idcategoriesnack' => $idcategoriesnack]);
													...
													<li>
														<div class="timeline-panel">
															<div class="media mr-2">
																<img alt="image" width="50" src="./snacks/<?php echo $product['imageSnack']; ?> ">
															</div>
															<div class="media-body">
																<h6 class="mb-1">You Are Out Of <?php echo $product['snackName']; ?> !</h6>
																<small class="d-block">Category: <?php echo $category; ?></small>
															</div>
														</div>
													</li>
												</ul>
        ...
        ***********************************-->
		<div class="content-body">
			...
			<h2>
				<a href="ajoutersnack.php" class="btn btn-primary light ">Ajouter Snacks</a>
			</h2>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
									...
									<tr>
										<td class="price"><?= $product['idcategoriesnack']; ?></td>
										<td class="price"><?= $product['snackName']; ?></td>
										<td><?= $product['idSnack']; ?></td>
										<td>
											<div class="new-arrivals-img-contnent">
												<img class="img-fluid" src="./snacks/<?php echo $product['imageSnack']; ?> " alt="" width="125" height="125">

											</div>
										</td>
										<td><?= $product['priceSnack']; ?></td>
										<td><?= $product['quantitySnack']; ?></td>


										<td align="center">
											<form method="POST" action="updatesnack.php">
												<input type="submit" name="update" value="Update">
												<input type="hidden" value=<?PHP echo $product['idSnack']; ?> name="idSnack">
											</form>
										</td>
										<td>
											<a href="deletesnack.php?idSnack=<?php echo $product['idSnack']; ?>" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip">
												<i class="ti-trash"></i>
											</a>
										</td>
									</tr>
