...
if (
	...
	if ($error == "")
		...
		if (
			...
			$productC->ajoutercategoriesnack($product);
									...
									<form action="" method="POST" id="OrderForm" enctype="multipart/form-data">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												<label for="categoriesnackName">Add the name of the Categorie Snack</label>
												<input type="text" class="form-control" placeholder="Categorie Snack" name="categoriesnack" id="categoriesnack">
											</div>
