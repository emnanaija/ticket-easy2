...
$list = $productC->listmoviecategory();

$product1C = new moviecategoryC();
$list1 = $product1C->listmoviecategory();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <h2>
                <a href="ajoutermoviecategory.php" class="btn btn-primary light ">Ajouter Categories</a>
            </h2>
                            ...
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <td><?= $product['idcategory']; ?></td>
                                        <td class="price"><?= $product['categoryName']; ?></td>
                                        
                                 


                                        <td align="center">
                                            <form method="POST" action="updatemoviecategory.php">
                                                <input type="submit" name="update" value="Update">
                                                <input type="hidden" value=<?PHP echo $product['idcategory']; ?> name="idcategory">
                                            </form>
                                        </td>
                                        <td>
                                            <a href="deletemoviecategory.php?idcategory=<?php echo $product['idcategory']; ?>" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip">
                                                <i class="ti-trash"></i>
                                            </a>
                                        </td>
                                    </tr>
