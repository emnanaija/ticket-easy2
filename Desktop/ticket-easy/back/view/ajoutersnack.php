...
if (
	...
	// Check file size
	if ($_FILES["imageSnack"]["size"] > 500000) {
									...
									<form action="" method="POST" id="OrderForm" enctype="multipart/form-data">
										...
										<div class="form-row">
											...
											<div class="form-group col-md-6">
												<label for="snackName">Add the name of the snack</label>
												<input type="text" class="form-control" placeholder="name" name="snackName" id="snackName">
											</div>

											<div class="form-group col-md-6">
												<label for="priceSnack">Add the price of the Snack</label>
												<input type="number" class="form-control" placeholder="price" name="priceSnack" id="priceSnack">
											</div>

											<div class="form-group col-md-6">
												<label for="quantitySnack">Add the quantity of the Snack</label>
												<input type="number" class="form-control" placeholder="quantity" name="quantitySnack" id="quantitySnack">
											</div>
											...
											<div class="form-group col-md-6">
												<label>image</label>
												<input type="file" name="imageSnack" id="imageSnack">
											</div>
