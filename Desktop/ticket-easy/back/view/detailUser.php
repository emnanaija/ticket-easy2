...
$result = $pdo->query('SELECT * from client where idClient ="' . $varname . '"');
                                        ...
                                        <ul class="timeline">
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">Rihem Send you Photo</h6>
                                                        <small class="d-block">11 Mars 2023 - 02:26 PM</small>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">Reminder : Snack Time!</h6>
                                                        <small class="d-block">11 Mars 2023 - 02:26 PM</small>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">erij Send you a Snack Photo</h6>
                                                        <small class="d-block">11 Mars 2023 - 02:26 PM</small>
                                                    </div>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">Reminder : Movie Time!</h6>
                                                        <small class="d-block">11 Mars 2023 - 02:26 PM</small>
                                                    </div>
                                                </div>
                                            </li>
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                ...
                <div class="copyright">
                    <p><strong>Ticketeasy - Movie site Admin Dashboard</strong> © 2020 All Rights Reserved</p>
                    <p>Made with <i class="fa fa-heart"></i> by Innovators</p>
                </div>
            </div>
        </div>
        <!--**********************************
                    ...
                    <div class="col-12">
                        ...
                        <div class="table-responsive">
                            <table border=1 align="center" width="170%">
                                ...
                                // $user=$userC->showUser($user['idUser']); 

                                ?>

                                <tr>
                                    <!-- <td><input type="text" value="<?php $userdata['idClient']; ?>" id="idUser" name="idUser"></td> -->
                                    <td><?php echo $userdata['idClient']; ?></td>
                                    ...
                                    <td><?php echo $userdata['numberClient']; ?></td>
                                    <td><?php echo $userdata['dob']; ?></td>
                                    <td><?php echo $userdata['isbanned']; ?></td>
