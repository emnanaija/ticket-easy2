...
$list = $productC->listPayments();

$product1C = new PaymentC();
$list1 = $product1C->listPayments();
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    ...
                                    <img src="./images/rania.png" width="20" alt="" />
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <div class="table-responsive">
                            <table id="example5" class="display mb-4 dataTablesCard" style="min-width: 845px;">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        <td class="price"><?= $product['idPay']; ?></td>
                                        <td><?= $product['Total']; ?></td>
                                        ...
                                        <td align="center">
											<form method="POST" action="updatepayment.php">
												...
												<input type="hidden" value=<?PHP echo $product['idPay']; ?> name="idPay">
											</form>
										</td>
										<td>
											<a href="deletepayment.php?idPay=<?php echo $product['idPay']; ?>" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip">
												<i class="ti-trash"></i>
											</a>
										</td>
                                    </tr>
