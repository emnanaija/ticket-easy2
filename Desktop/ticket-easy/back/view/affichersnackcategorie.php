...
$list = $productC->listcategoriesnack();

$product1C = new categoriesnackC();
$list1 = $product1C->listcategoriesnack();
?>
<!DOCTYPE html>
<html lang="en">
	...
	<div id="main-wrapper">
							...
							<div class="card-body contacts_body p-0 dz-scroll" id="DZ_W_Contacts_Body2">
								<ul class="contacts">
									...
									<li>
										<div class="d-flex bd-highlight">
											<div class="user_info">
												<span>john just buy your categoriesnack..</span>
												<p>10 Aug 2020</p>
											</div>
											<div class="ml-auto">
												<a href="#" class="btn btn-primary btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
							...
							<li class="nav-item dropdown notification_dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right">
									...
									<div id="DZ_W_Notification1" class="widget-media dz-scroll p-3" style="height:380px;">
										...
										?>
											<?php
											if ($product['quantitycategoriesnack'] == 0) {
													...
													<li>
														<div class="timeline-panel">
															<div class="media mr-2">
																<img alt="image" width="50" src="./categoriesnacks/<?php echo $product['imagecategoriesnack']; ?> ">
															</div>
															<div class="media-body">
																<h6 class="mb-1">You Are Out Of <?php echo $product['categoriesnackName']; ?> !</h6>
																<small class="d-block">It'S Category: <?php echo $product['category']; ?> </small>
															</div>
														</div>
        ...
        ***********************************-->
		<div class="content-body">
			<h1>List Of categories Snacks</h1>
			<h2>
				<a href="ajoutersnackcategorie.php" class="btn btn-primary light ">Ajouter categories Snacks</a>
			</h2>
					...
					<div class="col-12">
						<div class="table-responsive">
							<table id="example5" class="display mb-4 dataTablesCard" style="min-width: 845px;">
								<thead>
									<tr>
										<th>categories Snack ID</th>
										<th>categories Snack Name</th>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="new-arrival-product">
									...
									<tr>
										<td><?= $product['idcategoriesnack']; ?></td>
										<td class="price"><?= $product['categoriesnack']; ?></td>


										<td align="center">
											<form method="POST" action="updatesnackcategorie.php">
												<input type="submit" name="update" value="Update">
												<input type="hidden" value=<?PHP echo $product['idcategoriesnack']; ?> name="idcategoriesnack">
											</form>
										</td>
										...
										<td>
											...
											$id = $product['idcategoriesnack'];
											// Check if there are any snacks associated with this category
											$sql = "SELECT COUNT(*) as count FROM snack WHERE idcategoriesnack = $id";
											...
											if ($result['count'] > 0) {
												...
												echo '<a href="deletesnackcategorie.php?idcategoriesnack=' . $product['idcategoriesnack'] . '" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip"><i class="ti-trash"></i></a>';
											}
										...
										<script>
											function showAlert(trashIcon) {
												...
												alertBox.innerHTML = "Cannot delete this category as it has snacks associated with it";
