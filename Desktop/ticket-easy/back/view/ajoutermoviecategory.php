...
if (
	...
	if ($error == "")
		...
		if (
			...
			$productC->ajoutermoviecategory($product);
...
<div class="form-group col-md-6">
	<label for="productName">Add the name of the Movie Category</label>
	<input type="text" class="form-control" placeholder="Movie Category" name="categoryName" id="categoryName">
</div>
