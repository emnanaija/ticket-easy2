...
$product1C = new MovieC();
$list1 = $product1C->listMovie();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="main-wrapper">
                                                    ...
                                                    <li>
                                                        <div class="timeline-panel">
                                                            <div class="media mr-2">
                                                                <img alt="image" width="50" src="./images/<?php echo $product['moviePoster']; ?> ">
                                                            </div>
                                                            <div class="media-body">
                                                                <h6 class="mb-1">You Are Out Of <?php echo $product['movieName']; ?> !</h6>
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <h2>
                <a href="ajoutermovie.php" class="btn btn-primary light ">Ajouter Movies</a>
            </h2>
                            ...
                            <div class="card-body">
                                <div class="new-arrival-product">
                                    ...
                                    <tr>
                                        ...
                                        <td class="price"><?= $product['movieName']; ?></td>
                                        <td><?= $product['idMovie']; ?></td>
                                        <td>
                                            <div class="new-arrivals-img-contnent">
                                                <img class="img-fluid" src="./images/<?php echo $product['moviePoster']; ?> " alt="" width="125" height="125">

                                            </div>
                                        </td>


                                        <td><?= $product['dateMovie']; ?></td>
                                        <td><?= $product['priceTicket']; ?></td>
                                        <td><?= $product['quantityTickets']; ?></td>


                                        <td align="center">
                                            <form method="POST" action="updatemovie.php">
                                                <input type="submit" name="update" value="Update">
                                                <input type="hidden" value=<?PHP echo $product['idMovie']; ?> name="idMovie">
                                            </form>
                                        </td>
                                        <td>
                                            <a href="deletemovie.php?idMovie=<?php echo $product['idMovie']; ?>" class="text-danger" data-bs-original-title="Delete" data-bs-toggle="tooltip">
                                                <i class="ti-trash"></i>
                                            </a>
                                        </td>
                                    </tr>
