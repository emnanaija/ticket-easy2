...
if (
	...
	if (
		!empty($_POST["idOrder"]) &&
		!empty($_POST["orderDate"]) &&
		!empty($_POST["orderState"]) &&
		!empty($_POST["idClient"]) &&
		!empty($_POST["priceTotal"])
	) {
		$order = new Order(
			$_POST['idOrder'],
			new DateTime($_POST['orderDate']),
			$_POST['orderState'],
			$_POST['idClient'],
			$_POST['priceTotal']
		);
	...
	<div id="main-wrapper">
        ...
        ***********************************-->
		<div class="content-body">
			<!-- row -->
			<a href="ListOrders.php">Go To Orders </a>
			<hr>
			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						<h2 class="text-black font-w600 mb-0">Update Your Order</h2>
						<ol class="breadcrumb">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="basic-form">
									...
									$order = $orderC->showOrder($_GET['idOrder']);
									...
									<form action="" method="POST">
										...
										<div class="form-row">
											<div class="form-group col-md-6">
												...
												<input type="text" class="form-control" readonly value="<?php echo $order['idOrder']; ?>" id="idOrder" name="idOrder">
											</div>
											<div class="form-group col-md-6">
												<label>User ID</label>
												<input type="text" class="form-control" readonly value="<?php echo $order['idClient']; ?>" id="idUser" name="idClient">
											</div>
											<fieldest class="form-group col-md-6">

												<select id="orderState" name="orderState">
													<option value="">Select order</option>
													<option name="orderState" id="orderState" value="Ready">Ready</option>
													<option name="orderState" id="orderState" value="Waiting">Pending</option>
												</select>
											</fieldest>
										...
										<div class="form-group col-md-6">
											...
											<input type="date" class="form-control" value="<?php echo $order['orderDate']; ?>" min="<?php echo date('Y-m-d'); ?>" id="orderDate" name="orderDate">
										</div>
										<div class="form-group col-md-6">
											<label>Price</label>
											<input type="number" class="form-control" Readonly value="<?php echo $order['priceTotal']; ?>" id="priceTotal" name="priceTotal">
										</div>
								</div>
