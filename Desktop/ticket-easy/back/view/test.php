...
<head>
    ...
    <title>ticketeasy backend</title>
    <!-- Favicon icon -->
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            ...
            <img class="logo-abbr" src="./images/TheaterLogo.png" alt="">
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <center>
                ...
                <h2>
                    <a href="addclient.php" class="btn btn-primary light ">Add client</a>
                </h2>
            </center>
            <div class="container-fluid">
                <div class="form-head d-flex mb-3 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-0">clients</h2>
                        <p class="mb-0">Here is your client list data</p>
                    </div>
        ...
        ?>
                                <tr>
                                    ...
                                    <td><?= $client['email']; ?></td>
                                    <td><?= $client['numberClient']; ?></td>
                                    <td><?= $client['dob']; ?></td>
                                    <td><?= $client['password']; ?></td>
                                    <td align="center">
                                        <form method="POST" action="updateClient.php">
                                            <input type="submit" name="update" value="Update" class="btn btn-primary light " >
                                            <input type="hidden" value=<?PHP echo $client['idClient']; ?>
                                            name="idClient">
                                        </form>
                                    </td>
